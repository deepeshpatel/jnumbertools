 ...
 */
package io.github.deepeshpatel.jnumbertools.core.internal.generator.product;
...
public class CartesianProductByRanks<T> implements StreamableIterable<T> {
     ...
     * {@link SimpleProductBuilder#byRanks(Iterable)}
     * or {@link ConstrainedProductBuilder#byRanks(Iterable)}.
