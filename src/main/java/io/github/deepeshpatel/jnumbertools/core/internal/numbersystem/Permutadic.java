...
import static io.github.deepeshpatel.jnumbertools.core.internal.numbersystem.PermutadicAlgorithms.*;
...
public final class Permutadic implements Serializable {
    ...
    /**
     * Converts this Permutadic representation to an mᵗʰ permutation of specified length.
     * <p>
     * The permutation is generated by selecting {@code countOfSelectItems} elements from a set
     * of size {@code degree + countOfSelectItems}, using the stored permutadic digits as
     * indices for element selection.
     * </p>
     *
     * @param countOfSelectItems the number of elements to select for the permutation (k)
     * @return an array of length k containing indices representing the mᵗʰ permutation
     * @see PermutadicAlgorithms#toMthPermutation(List, int, int)
     */
