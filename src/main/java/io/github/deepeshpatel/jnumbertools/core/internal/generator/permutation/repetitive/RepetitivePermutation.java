 ...
 */
package io.github.deepeshpatel.jnumbertools.core.internal.generator.permutation.repetitive;
...
public final class RepetitivePermutation<T> extends AbstractGenerator<T> {
     ...
     * Instances should be created via {@link io.github.deepeshpatel.jnumbertools.api.Permutations#repetitive(int, List)}.
    ...
    public Iterator<List<T>> iterator() {
        ...
        if(elements.isEmpty() && size==0) return emptyListIterator(); // 0⁰ = 1 -> returns [[]]
