 ...
 */
package io.github.deepeshpatel.jnumbertools.core.internal.generator.permutation.multiset;

import io.github.deepeshpatel.jnumbertools.core.external.Calculator;
import io.github.deepeshpatel.jnumbertools.core.internal.generator.permutation.iterator.UniquePermutationLexElementIterator;
 ...
 * Use {@link io.github.deepeshpatel.jnumbertools.api.Permutations#multiset(LinkedHashMap)} to create instances.
...
public final class MultisetPermutation<T> extends AbstractMultisetPermutation<T> {
    ...
    MultisetPermutation(LinkedHashMap<T, Integer> multiset, Calculator calculator) {
        ...
        //so I am choosing the simple flattening
