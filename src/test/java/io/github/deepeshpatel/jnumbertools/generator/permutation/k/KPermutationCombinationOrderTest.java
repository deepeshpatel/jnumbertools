...
public class KPermutationCombinationOrderTest {
    ...
    public void shouldReturnSameResultForDifferentIteratorObjects(){
        KPermutationCombinationOrder<String> iterable = tools.permutations().nPr(2,"A", "B", "C")
                .combinationOrder();
    ...
    public void shouldThrowExceptionForNegativeK() {
        tools.permutations().nPr(-3, new ArrayList<>()).combinationOrder();
    }
    ...
    public void shouldGenerateAllUniquePermutationsOf3Values(){
        ...
        String actual   = tools.permutations().nPr(2,1,2,3)
                .combinationOrder()
                .stream().toList().toString();
    ...
    public void shouldGenerateKPermutations() {
        ...
        var output = tools.permutations().nPr(2, "A", "B", "C")
                .combinationOrder()
                .stream()
                .toList();
    ...
    public void shouldGenerateOneEmptyPermutationForKEqualsZero() {
        ...
        var output = tools.permutations().nPr(0, "A")
                .combinationOrder()
                .stream()
                .toList();
