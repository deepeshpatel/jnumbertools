...
/**
 * Comprehensive test suite for {@link InvolutadicIncrementStateMachineV2}.
 *
...
class InvolutadicIncrementStateMachineV2Test {

    private Calculator calculator;
    private InvolutadicAlgorithmsV2 alg;

    @BeforeEach
    void setUp() {
        calculator = new Calculator();
        alg = new InvolutadicAlgorithmsV2(calculator);
    }
     ...
     */
    private void assertStateConsistent(InvolutadicIncrementStateMachineV2 engine, int n) {
    ...
    class SequentialEnumeration {
        ...
        void stateMachineMatchesAlgorithmForAllRanks(int n) {
            ...
            var engine = new InvolutadicIncrementStateMachineV2(n, 0L, calculator);
        ...
        void stateMachineDigitsMatchAlgorithmIncrement(int n) {
            ...
            for (BigInteger rank = BigInteger.ZERO;
                ...
                var engine = new InvolutadicIncrementStateMachineV2(n, rank, calculator);
    ...
    class StartFromRanks {
        ...
        void startFromMidRankAndEnumerate(int n) {
            ...
            for (BigInteger startRank : startRanks) {
                var engine = new InvolutadicIncrementStateMachineV2(n, startRank, calculator);
    ...
    class BoundaryConditions {
        ...
        void startAtLastRank() {
            ...
            var engine = new InvolutadicIncrementStateMachineV2(n, lastRank, calculator);
    ...
    class CarryLength {
        ...
        void carryLengthZeroAtEnd() {
            int n = 4;
            var engine = new InvolutadicIncrementStateMachineV2(n,
    ...
    class ConstructorValidation {
        ...
        void invalidN() {
            assertThrows(IllegalArgumentException.class,
                    () -> new InvolutadicIncrementStateMachineV2(0, 0L, calculator));
            assertThrows(IllegalArgumentException.class,
                    () -> new InvolutadicIncrementStateMachineV2(-1, 0L, calculator));
        }
        ...
        void nullCalculator() {
            assertThrows(NullPointerException.class,
                    () -> new InvolutadicIncrementStateMachineV2(5, 0L, null));
        }
        ...
        void rankOutOfRange() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new InvolutadicIncrementStateMachineV2(n, -1L, calculator));
            assertThrows(IllegalArgumentException.class,
                    () -> new InvolutadicIncrementStateMachineV2(n, total, calculator));
        }
    }
    ...
    class PerformanceSanity {
        ...
        void sanityCheckIncrementPerformance() {
            ...
            // Reset
            engine = new InvolutadicIncrementStateMachineV2(n, 0L, calculator);
